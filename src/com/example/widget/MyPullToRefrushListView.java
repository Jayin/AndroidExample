...
public class MyPullToRefrushListView extends ListView implements OnScrollListener {
    ...
    public MyPullToRefrushListView(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init(context);  
    }  
    
    public MyPullToRefrushListView(Context context, AttributeSet attrs, int defStyle) {  
